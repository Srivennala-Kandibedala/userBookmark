...
public class DataStore {
	...
	private static void loadMovies() {
		bookmarks[1][0] = BookmarkManager.getinstance().createMovie(3000,"Citizen Kane","",1941,new String[]{"Henry Fonda","Jane Darwell"},new String[]{"Orson Welles"},MovieGenre.CLASSICS,8.5);
		bookmarks[1][1] = BookmarkManager.getinstance().createMovie(3001,"The Grapes of Wrath","",1940,new String[]{"Orson Welles","Joseph Cotten"},new String[]{"John Ford"},MovieGenre.CLASSICS,8.2);
	...
	private static void loadBooks() {
		...
		bookmarks[2][1] = BookmarkManager.getinstance().createBook(4001,"Self-Reliance and Other Essays","",1854,"Dover Publications",new String[]{"Ralph Waldo Emerson"},BookGenre.PHILOSOPHY,4.5);
